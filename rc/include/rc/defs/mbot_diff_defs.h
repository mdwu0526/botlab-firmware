...
#define WHEEL_RADIUS            TEST     // change your wheel radius to your specific measurements
...
#define M3_INT 					0.00576415 		  // define your mbot-specific motor 3 intercept (duty cycle to get motor moving)
